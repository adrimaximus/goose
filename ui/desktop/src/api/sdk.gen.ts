...
export const archiveSession = <ThrowOnError extends boolean = false>(options: Options<ArchiveSessionData, ThrowOnError>) => (options.client ?? client).put<ArchiveSessionResponses, ArchiveSessionErrors, ThrowOnError>({ url: '/sessions/{session_id}/archive', ...options });
...
export const unarchiveSession = <ThrowOnError extends boolean = false>(options: Options<UnarchiveSessionData, ThrowOnError>) => (options.client ?? client).put<UnarchiveSessionResponses, UnarchiveSessionErrors, ThrowOnError>({ url: '/sessions/{session_id}/unarchive', ...options });
